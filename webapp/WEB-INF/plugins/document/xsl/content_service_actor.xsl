        ...
        <p>
            <xsl:choose>
                <xsl:when test="actor-photo/file-resource!=''">
                      <img src="servlet/plugins/document/resource?id={actor-photo/file-resource/resource-document-id}&amp;id_attribute={actor-photo/file-resource/resource-attribute-id}" align="left" valign="middle" hspace="20" />
                </xsl:when>
                <xsl:otherwise>               
               </xsl:otherwise>        
            </xsl:choose>
